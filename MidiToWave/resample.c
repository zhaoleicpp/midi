...
const static float newt_coeffs[58][58] = {
#include "newton_table.c.h"
};
...
const static double newt_recip[60] = { 0, 1, 1.0/2, 1.0/3, 1.0/4, 1.0/5, 1.0/6, 1.0/7,
...
const static resampler_t resamplers[] = {
    resample_cspline,
    resample_lagrange,
    resample_gauss,
    resample_newton,
...
{
	memset(gauss_table,0,sizeof(gauss_table));
...
#ifdef FIXED_RESAMPLATION
#else
	cur_resample = DEFAULT_RESAMPLATION;
#endif
	memset(resample_buffer,0,sizeof(resample_buffer));
}
