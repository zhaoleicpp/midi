...
#define mac_play_mode raw_play_mode
...
const PlayMode *play_mode_list[] = {
  ...
  &wave_play_mode,
  &raw_play_mode,
  //&au_play_mode, //Zhao Lei
  //&aiff_play_mode, //Zhao Lei
#ifdef AU_VORBIS
  &vorbis_play_mode,
#endif /* AU_VORBIS */
#ifdef AU_FLAC
  ...
  &list_play_mode,
#endif /* __MACOS__ */
  //&midi_play_mode,//Zhao Lei
  //&modmidi_play_mode,//Zhao Lei
  NULL
};
